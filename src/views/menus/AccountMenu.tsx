...
const mintscanUri = "https://testnet.mintscan.io/dydx-testnet/account";
          ...
          <Styled.AccountInfo>
            <Styled.AddressRow>
              ...
              <IconButton
                ...
                onClick={() =>
                  dydxAddress && navigator.clipboard.writeText(dydxAddress)
                }
                shape={ButtonShape.Square}
              />
              <IconButton
                action={ButtonAction.Base}
                href={`${mintscanUri}/${dydxAddress}`}
            ...
            <Styled.AddressRow>
              ...
              <IconButton
                ...
                iconName={IconName.Copy}
                onClick={() =>
                  evmAddress && navigator.clipboard.writeText(evmAddress)
                }
                shape={ButtonShape.Square}
              />
              <IconButton
                action={ButtonAction.Base}
                href={`${etherscanUri}/${evmAddress}`}
                iconName={IconName.LinkOut}
                shape={ButtonShape.Square}
                type={ButtonType.Link}
              />
