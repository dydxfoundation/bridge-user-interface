...
export const formatRelativeTimeFromMs = (
  elapsedMs: number,
  {
    locale,
...
export const formatRelativeTime = (
  ...
  formatRelativeTimeFromMs(
    Math.abs(timestamp - relativeToTimestamp),
    Math.sign(timestamp - relativeToTimestamp),
    { locale, format, largestUnit, resolution, stripRelativeWords }
  );
